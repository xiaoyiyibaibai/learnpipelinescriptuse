...
public class RSACoder {
   ...
   public static class AFactUtil{
    ...
    public static void main(String[] args) throws Exception {
        ...
        //甲方进行数据的加密
        byte[] code1 = AFactUtil.encryptByPrivateKey(str.getBytes(), privateKey);
        System.out.println("加密后的数据：" + Base64.encodeBase64String(code1));
        System.out.println("===========乙方使用甲方提供的公钥对数据进行解密==============");
        //乙方进行数据的解密
        byte[] decode1 = BFactUtil.decryptByPublicKey(code1, publicKey);
        ...
        //甲方使用私钥对数据进行解密
        byte[] decode2 = AFactUtil.decryptByPrivateKey(code2, privateKey);
